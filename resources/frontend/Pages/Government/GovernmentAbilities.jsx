...
export default function GovernmentAbilities() {
  const documents = [
    {title: 'Закон Республики Ингушетия «Устав Республики Ингушетия» от 18.02.2009 № 20-ОЗ', document_type: 'PDF', document_size: '221 КБ', document_path: ''},
    {title: 'Указ Главы Республики Ингушетия от 06.02.2019 № 16-уг', document_type: 'PDF', document_size: '2 499 КБ', document_path: ''},
    {title: 'Закон Республики Ингушетия «О Правительстве Республики Ингушетия и исполнительных органах государственной власти республики» от 06.05.2011 № 42-ОЗ', document_type: 'PDF', document_size: '63 КБ', document_path: ''},
  ]

                                        ...
                                        @if(isset($mountains))
                                            @foreach($mountains as $item)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td style="">
                                                        <div class="btn-group">
                                                            <a href="{{route('admin.mountains.edit', $item->id)}}" class="btn btn-outline-primary waves-effect waves-light">Редактировать</a>
                                                            <form action="{{route('admin.mountains.delete', $item->id)}}" method="post">
                                                                @csrf
                                                                @method('delete')

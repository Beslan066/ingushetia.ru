                                    ...
                                    @if(isset($agencies))
                                        @foreach($agencies as $agency)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="" tabindex="0">{{$agency->name}}</td>
                                                <td>Нет</td>
                                                <td class="sorting_1">{{$agency->created_at}}</td>
                                                <td style="">
                                                    <div class="btn-group">
                                                        <a class="btn btn-outline-success waves-effect waves-light mr-2">Перевод</a>
                                                        <a href="{{route('admin.agencies.edit', $agency->id)}}" class="btn btn-outline-primary waves-effect waves-light mr-2">Редактировать</a>

            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-2 d-flex justify-content-between">
                        <div>
                            <h2>Поддержка семей военнослужащих</h2>
                        </div>

                        <div>
                            <a href="{{route('admin.militarySupport.create')}}">
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td style="">
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="{{route('admin.militarySupport.edit', $item->id)}}" class="btn btn-outline-primary waves-effect waves-light">Редактировать</a>
                                                        <form action="{{route('admin.militarySupport.delete', $item->id)}}" method="post">
                                                            @csrf
                                                            @method('delete')
